...
import 'Search.dart';
class ProductByCatName extends StatefulWidget {
  String cat_id;
  ProductByCatName(this.cat_id);
  @override
  _ProductByCatNameState createState() => _ProductByCatNameState();
}

class _ProductByCatNameState extends State<ProductByCatName> {
  ...
  Future<void> getProducts()async{
    ...
    try{
      http.Response response =  await http.post(
          API.fetch_product_by_catname,
          body: {
            'authkey' : API.key,
            'cat_name' : widget.cat_id,
          }
      );
      print(response.body);
