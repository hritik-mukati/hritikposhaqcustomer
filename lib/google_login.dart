        ...
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: Text("Authenticate Mobile Number",style: TextStyle(fontSize: 16),),
            ),
          ),
          Padding(
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(50,20,50,20),
            child: loding?RaisedButton(
              color: Constants.PRIMARY_COLOR,
              child: Text("Send OTP ",style: TextStyle(color: Constants.ACCENT_COLOR,fontSize: 16),),
              onPressed: (){
                if(mobile!=null){
                  setState(() {
                    loding = false;
                  ...
                  Fluttertoast.showToast(msg: "Insert Mobile number!",gravity: ToastGravity.BOTTOM,backgroundColor: Colors.red,textColor: Colors.white,);
                }
              },
            ):Row(
              ...
              children: [
                RaisedButton(
                  color: Constants.PRIMARY_COLOR,
                  child: Text("Wait a Moment",style: TextStyle(color: Constants.ACCENT_COLOR,fontSize: 16),),
                  onPressed: (){
                  ...
                  Padding(
                    ...
                    child:Container(
                      //                        width:MediaQuery.of(context).size.width-10,
                        child: Center(child: Text("OTP has been sent to your number $mobile. Please enter it below..",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,fontStyle: FontStyle.italic),))),
                  ),
                  Padding(
