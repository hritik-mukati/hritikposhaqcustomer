      ...
      if(response.statusCode==200){
       ...
       if(responsed["status"]==2){
         ...
         setState(() {
           ...
           addStringToSF("customer_id", responsed["result"][0]["customer_id"].toString());
         ...
         Fluttertoast.showToast(msg: responsed["message"],backgroundColor: Colors.red,textColor: Colors.white);
       }
      }
      else{
        setState(() {
        ...
        Fluttertoast.showToast(msg:"Network Error!!",backgroundColor: Colors.red,textColor: Colors.white);
      }
    }
  }
...
addlogin()async{
  ...
  void check()async{
    ...
    if(response.statusCode==200){
      ...
      if(responsed['status']==2){
        ...
        Fluttertoast.showToast(msg: responsed['message'].toString(),backgroundColor: Constants.PRIMARY_COLOR);
      }
    }else{
      setState(() {
        loding = true;
        Fluttertoast.showToast(msg: "Netowrk Error!",backgroundColor: Constants.PRIMARY_COLOR);
      });
    }
  }
  void sendOTP(String mobile,bool type)async{
    ...
    if(responsed['status']==2){
      ...
      Fluttertoast.showToast(msg: responsed['message']);
      if(type)showModalBottomSheet(context: context,isScrollControlled: true, builder:(context){
    ...
    return complete?Stack(
      children: <Widget>[
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child:Text("Verify Mobile Number",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                  ),
                  Padding(
                    padding: EdgeInsets.only(top:20,left: 30,right: 30),
                    child:Container(
                      //                        width:MediaQuery.of(context).size.width-10,
                        child: Center(child: Text("OTP has been sent to your number $rmobile. Please enter it below..",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,fontStyle: FontStyle.italic),))),
                  ),
                  Padding(
                      ...
                      onCompleted: (pin) async{
                        ...
                        try{
                          ...
                          if(code == otp){
                            ...
                            signup(rname,remail,rmobile,rpass,gender,datecontroller.text);
                          }else{
                            print("Invalid OTP");
                            setState(() {
                              complete = true;
        ...
        Padding(
          ...
          child: Container(
              height: 100,
              child: Center(child:CircleAvatar(radius:35,child: Icon(Icons.chat,size: 45,)))),
        ),
      ],
    )
        :Container(child: ProgressDailog().Progress(context),);
  }
  @override
                          ...
                          child: DefaultTabController(
                            ...
                            appBar: TabBar(
                              indicator: UnderlineTabIndicator(
                                ...
                                insets: EdgeInsets.fromLTRB(60, 10, 60, 10)
                              ),
                              tabs: <Widget>[
                                Tab(child: Text("LOG IN",style: TextStyle(color:Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),),
                                Tab(child: Text("SIGN UP",style: TextStyle(color:Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),)
                              ],
                            ),
                              body: TabBarView(
                                children: <Widget>[
                                  load?Container(color: Constants.ACCENT_COLOR,child: ProgressDailog().Progress(context),):Padding(
                                        ...
                                        TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              suffixIcon: IconButton(
                                                  onPressed: _ltoggle,
                                                  icon: Icon(_lobscureText ? Icons.visibility : Icons.visibility_off))
                                          ),
                                        ),
                                        Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            onPressed: (){
                                                print("button");
                                                print(lpass.text);
                                                checkLogin(lmail.text,lpass.text);
                                            },
                                            ),
                                          ),
                                        ),
                                  ...
                                  loding?Padding(
                                    ...
                                    child: ListView(
                                      children: <Widget>[
                                        ...
                                        TextFormField(
                                          maxLength: 10,
                                          initialValue: rmobile!=null?rmobile.substring(3):"",
                                        ...
                                        TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            suffixIcon: IconButton(
                                                onPressed: _stoggle,
                                                icon: Icon(_sobscureText ? Icons.visibility : Icons.visibility_off))
                                            ),
                                        ...
                                        Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: FlatButton(
                                              ...
                                              onPressed: (){
                                                if(rpass==rconpass){
                                                  print(rname+" "+remail+" "+rmobile+" "+datecontroller.text+" "+gender+" "+rpass);
                                                  if(rname!= null&&remail!=null&&rmobile!=null&&datecontroller.text!=null&&gender!="Gender"&&rpass!=null){
                                                    print("calling");
                                                    if(rpass.length>5){
                                                      check();
                                                    }else{
                                                      print("pass short");
                                                      Fluttertoast.showToast(msg: "Password should be greater than 6 character!",backgroundColor: Colors.red,textColor: Colors.white);
                                                    }
                                                  }else{
                                                    Fluttertoast.showToast(msg: "All Fields Are mendetory!!",backgroundColor: Colors.red,textColor: Colors.white);
                                                  }
                                                }else{
                                                  Fluttertoast.showToast(msg: "Password Does't Match",backgroundColor: Colors.red,textColor: Colors.white);
                                                }
                                              },
                                            ),
                                          ),
                                  ...
                                  ):Container(color: Constants.ACCENT_COLOR,child: ProgressDailog().Progress(context),),
                                ],
                              ),
                            ),
                          ),
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                              width: 35,
                              height: 35,
                              child: Center(child: Image.asset("images/google_logo.png"))),
                        ),
                      )
                    ],
                  ),
  ...
  _login_google()async{
    try{
      ...
      Fluttertoast.showToast(backgroundColor:Colors.black,msg: "Wait A Second!",fontSize: 18,textColor: Colors.white, gravity:ToastGravity.CENTER);
      setState(() {
        print(_googleSignIn.currentUser.email);
        print(_googleSignIn.currentUser.displayName);
        print(_googleSignIn.currentUser.id);
        checklogingoogle(_googleSignIn.currentUser.email,_googleSignIn.currentUser.displayName,_googleSignIn.currentUser.photoUrl);
      });
    }catch(e){
      print(e.toString());
    }
  ...
  checklogingoogle(String email,String name,String photo)async{
    ...
    setState(() {
      ...
      if(responsed['status']==1){
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context)=>GoogleLogin(email,name,photo))).then((value) => _logout_google());
      }
      else
        if(responsed['status'] == 2){
        print("Already defined");
        load  = false;
        addlogingoogle(email,name,photo,responsed['result'][0]['mobile'].toString(),responsed['result'][0]['customer_id'].toString());
      }
      else{
        _logout_google();
        setState(() {
